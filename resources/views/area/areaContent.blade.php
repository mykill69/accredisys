            ...
            <div class="card shadow-sm mt-3">
                <div class="row">
                    <div class="card-body pb-0">
                        <h4 class="mb-3 text-success">{{ $area->program?->prog_name ?? 'No Program Found' }}</h4>
                    ...
                    <form id="uploadForm">
                        @foreach ($area->parameters as $parameter)
                            <div class="row mb-2 p-2">
                                <div class="col">
                                    <span class="text-bold">{{ $parameter->param_name }}.
                                    ...
                                    <div class="upload-box border border-dashed p-3 mt-2 text-center"
                                        ...
                                        <i class="fas fa-file-pdf text-muted"></i> <span class="text-muted">Drag & drop PDF here or click to select</span>
                                        <input type="file" name="files[{{ $parameter->id }}][]" accept="application/pdf"
